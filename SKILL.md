...
notification-history-rule-builder の作業手順です。
...
- asset は `dist/notification-history-rule-builder-docs.zip`、`docs/manual-test.md`、`docs/strict-manual-test-addendum.md`。
